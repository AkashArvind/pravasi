    ...
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="col-md-12">
            <h2>News</h2>
            <hr>
            <a  style="float:right" href="add_news.php" class="btn btn-info btn-sm text-right">Add New</a> <br><br>
            <?php
            if(isset($_GET['msg'])){
              ?>
            ...
            <form action="php/delete.inc.php" method="get" name="checkboxFormPhotos" id="checkboxFormPhotos" onsubmit="return confirm('Delete selected news?');"> 
                <div class="col-md-12">
                  ...
                  <input style="margin-top: 10px" type="submit" class="btn  btn-sm btn-danger" name="News"value="Delete " id="photobtn" disabled="disabled">
                  <br><br>
                  <?php
                  ...
                  <?php 
                  $table_nme = 'news';       
                  $result="SELECT * FROM $table_nme ORDER BY news_id DESC ";
                  ...
                  ?>
                    ...
                    <?php
                      while ($r = mysql_fetch_array($q1)) 
                      {
                          $i = $i + 1;
                         $imagename=$r['image'];
                         $dataorg="../../assets/images/news/".$imagename;
                         if($imagename=="") {
                       ...
                       <tr>
                          <td style="text-align:left;">
                              <?=$i?><input type="checkbox" name="d<?=$i?>" value="<?= $r['news_id'] ?>" />
                          </td>
                          <td>
                              <?=$r['title']?>
                          </td>
                          ...
                          <td  class='text-right'>
                              <a href="editnews.php?news=<?=urlencode(base64_encode($r['news_id']))?>" ><span class="icon fa fa-edit fa-2x"></span></a>
                          </td>
