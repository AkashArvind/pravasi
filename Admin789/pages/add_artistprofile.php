...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="col-md-12">             
            <h4>Add New Artist<span style="float:right"><a href="artistprofiles.php" class="btn btn-info btn-sm">Back</a></span></h4>
                  ...
                  <tr class="info">
                    ...
                    <tr>
                      <td>Qualifications</td>
                        <td colspan="3">
                        <input type="text" class="form-control input-sm" name="qualification" required>
                        </td>
                    ...
                    <tr>
                      <td>Work Experiences</td>
                        <td colspan="3">
                        <textarea name="workexperience" class="form-control input-sm"></textarea>
                    ...
                    <tr>
                      <td>Profile Description</td>
                        <td colspan="3">
                        <textarea class="form-control input-sm" name="profiledescription" id="profiledescription" required="required"></textarea>
                        </td> 
                    </tr>
                    <tr>
                      <td>Certificates</td>
                        <td colspan="3">
                        <input type="file" class="form-control input-sm" name="certificate[]" required="required" multiple="">
                                        <small class="text-muted">Use CTRL key to select multiple files</small>
                    ...
                    <tr>
                      <td>Photo</td>
                       <td colspan="3">
                       <input type="file" class="form-control input-sm" id="photo" name="photo" accept="image/*" required>
                    ...
                    <tr>
                      <td>Facebook Id</td>
                        <td colspan="3">
                        <input type="text" class="form-control input-sm" name="fbid">
                        </td>
                    </tr>
                     <tr>
                      <td>Website Id</td>
                        <td colspan="3">
                        <input type="text" class="form-control input-sm" name="webid">
                        </td>
                    </tr>
                    <tr>  
                        <td colspan="4">
                          <button type="submit" name="addartist" class="btn btn-info btn-sm">Submit</button> 
