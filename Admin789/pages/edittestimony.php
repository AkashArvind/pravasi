...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="col-md-12">
            <h4>Testimonials<span style="float:right"><a href="testimony.php" class="btn btn-info btn-sm">Back</a></span></h4>
            <hr>
                              ...
                              <table class="table">
                                <tr class="info">
                                  ...
                                  <tr>
                                      <td>Content</td>
                                      <td colspan="3">
                                        <textarea class="form-control input-sm" name="content" required="required"><?=$r['content'];?></textarea>
                                      </td>
                                  </tr>
                                  <tr>
                                    <td>Name</td>
                                      <td colspan="3">
                                      <input type="text" class="form-control input-sm" name="name" required="required" value="<?=$r['name']?>">
                                      </td>                       
                                  </tr>
                                  <tr>
                                      <td colspan="4">
                                        <input type="hidden"  name="testimony" value="<?=$id?>">
