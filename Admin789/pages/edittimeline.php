...
if(isset($_GET['form']))
{
    ...
    $sql="select title,description,day,month,year from ".$table_name." where id='".$formid."'";
    $q=mysql_query($sql);
...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="col-md-12">             
            <h4>Edit Timeline<span style="float:right"><a href="timeline.php" class="btn btn-info btn-sm">Back</a></span></h4>
                ...
                <table class="table">
                  <tr class="info">
                    ...
                    <tr>
                      <td>വിവരണം</td>
                        <td colspan="3">
                        <textarea name="description" name="description" class="form-control input-sm" required ><?=$description?></textarea>
                      ...
                      <td>തീയതി</td>
                       <td colspan="3">
                         <div class='input-group date' id='form_datetime'>
                                  ...
                                  <input type='text' class="form-control"  name="form_datetime" required value="<?=$date?>" />
                                  <span class="input-group-addon">
                                      <span class="glyphicon glyphicon-calendar"></span>
                          </div>
                          <small>Format: dd/mm/yyyy. Sample: 13/07/2018</small>
                        </td>
                      
                    </tr>
                    <tr>  
                        <td colspan="4">
                          <button type="submit" name="edittimeline" class="btn btn-info btn-sm">Submit</button> 
                        </td>
                    </tr>
