            ...
            <div class="table-responsive">
                <table class="table">
                  <tr class="info">
                    ...
                    <tr>  
                        <td colspan="4">
                          <button type="submit" name="addgalleryinfo" class="btn btn-info btn-sm">Submit</button> 
                        </td>
                    </tr>
