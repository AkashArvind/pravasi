    ...
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="col-md-12">
            <h2>Courses</h2>
            <hr>
            <a  style="float:right" href="add_course.php" class="btn btn-info btn-sm text-right">Add New</a> <br><br>
            <?php
            if(isset($_GET['msg'])){
              ?>
            ...
            <form action="php/delete.inc.php" method="get" name="checkboxFormPhotos" id="checkboxFormPhotos" onsubmit="return confirm('Delete selected news?');"> 
                <div class="col-md-12">
                  ...
                  <input style="margin-top: 10px" type="submit" class="btn  btn-sm btn-danger" name="coursedel"value="Delete " id="photobtn" disabled="disabled">
                  <br><br>
                  <?php
                  ...
                  <?php 
                  $table_nme = 'courses';       
                  $result="SELECT id,name,description,image,type,subheading FROM $table_nme ORDER BY id DESC ";
                  ...
                  ?>
                    ...
                    <?php
                      while ($r = mysql_fetch_array($q1)) 
                      {
                          ...
                          $id=$r['id'];
                         $imagename=$r['image'];
                         $dataorg="../../assets/images/courses/".$imagename;
                       ...
                       <tr>
                          ...
                          <td>
                             <?php
                                ...
                                {?>
                                  <a href="../../assets/images/courses/<?= $imagename ?>" target="_blank" class="text-center btn ntn-success btn-xs">View</a>
                                 <?php
                                }
                                else
                                {?>
                          ...
                          <td>
                            <a href="" class="text-center btn ntn-success btn-xs" href="#" data-toggle="modal" data-target="#courseDetails<?=$i?>">View</a>
                          </td>
                          <div class="modal fade" id="courseDetails<?=$i?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog modal-lg" role="document">
                                  <div class="modal-content">
                                    <div class="modal-header">
                                      <h4  class="modal-title" id="exampleModalLabel">കോഴ്സ് വിശദാംശങ്ങൾ</h4>
                                    ...
                                    <div class="modal-body">
                                      <div class="form-row">
                                         <label for="Name" class="col-sm-3">കോഴ്സിന്റെ പേര്</label>
                                          <div class="col-sm-9">
                                      ...
                                      <div class="form-row">
                                         <label for="Name" class="col-sm-3">ഉപ തലക്കെട്ട്</label>
                                          <div class="col-sm-9">
                                            <label for="studentname"><?=" : ".$r['subheading']?></label> 
                                                  
                                        </div>
                                      </div>
                                      <div class="form-row">
                                         <label for="Name" class="col-sm-3">വിഭാഗം</label>
                                          <div class="col-sm-9">
                                      ...
                                      <div class="card-header"><h5>വിവരണം</h5></div>
                                       <div class="card-body">
                                         <?=$r['description']?>
                                       </div>            
                                       </div>  
                          ...
                          <td  class='text-right'>
                              <a href="editcourse.php?course=<?=urlencode(base64_encode($r['id']))?>" ><span class="icon fa fa-edit fa-2x"></span></a>
                          </td>
                          <td class='text-center'>
                            <a href="courseenglish.php?course=<?=urlencode(base64_encode($r['id']))?>" style="text-decoration: none;">English</a>
                          </td>
