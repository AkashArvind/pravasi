    ...
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="col-md-12">             
            ...
            <a href="<?= $dataorg?>" style="text-decoration: none;" data-title="<?=$coverimage?>" class="text-center btn ntn-success" data-lightbox="images">മുഖചിത്രം</a><?="]"?>
