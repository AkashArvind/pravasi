...
if(isset($_GET['id']))
{
    ...
    $sql="select boardofdirectors.name,boardofdirectors.position,boarddirectorawards.filename,boarddirectorawards.directorid from ".$table_name." inner join ".$table_name2." on boardofdirectors.id=boarddirectorawards.directorid where boarddirectorawards.id='".$id."'";
    $q=mysql_query($sql);
