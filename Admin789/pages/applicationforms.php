    ...
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="col-md-12">
            ...
            <hr>
            <a  style="float:right" href="add_applicationform.php" class="btn btn-info btn-sm text-right">Add New</a> <br><br>
            <?php
            if(isset($_GET['msg'])){
              ?>
            ...
            <form action="php/delete.inc.php" method="get" name="checkboxFormPhotos" id="checkboxFormPhotos" onsubmit="return confirm('Delete selected news?');"> 
                <div class="col-md-12">
                  ...
                  <input style="margin-top: 10px" type="submit" class="btn  btn-sm btn-danger" name="applicationformdel"value="Delete " id="photobtn" disabled="disabled">
                  <br><br>
                  <?php
                  ...
                  ?>
                  <?php 
                  $table_nme = 'applicationforms';       
                 
                  $result="SELECT id,filename,title FROM $table_nme ORDER BY id DESC ";
                  ...
                  ?>
                    ...
                    <?php
                      while ($r = mysql_fetch_array($q1)) 
                      {
                         ...
                         $dataorg="../../assets/images/applicationforms/".$imagename;
                       ...
                       <tr>
                          ...
                          <td>
                            <?php
                                ...
                                {?>
                                  <a href="../../assets/images/applicationforms/<?= $imagename ?>" target="_blank" class="btn ntn-success btn-xs">View</a>
                                 <?php
                                }
                                else
                                {?>
                          ...
                          <td  class='text-right'>
                              <a href="editapplicationform.php?form=<?=urlencode(base64_encode($r['id']))?>" ><span class="icon fa fa-edit fa-2x"></span></a>
                          </td>
