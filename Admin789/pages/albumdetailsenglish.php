...
if(isset($_GET['album']))
{
   ...
   $table_name="gallerysubcategory";
    $sql="select e_name,e_description,name,coverimage,categoryid from ".$table_name." where id='".$albumid."'";
    $q=mysql_query($sql);
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="col-md-12">             
            <h4>Album Name: <?=$name." ["?>
            <a href="<?= $dataorg?>" style="text-decoration: none;" data-title="<?=$coverimage?>" class="text-center btn ntn-success" data-lightbox="images">Cover Image</a><?="]"?>
            ...
            <div class="table-responsive">
                <table class="table">
                  <tr class="info">
                      <th colspan="4">Enter Album Details in English</th>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
                    ...
                    <tr>
                      <td>Description</td>
                        <td colspan="3">
                        <textarea name="edescription" rows="" cols="40" class="form-control input-sm" required><?=$edescription?></textarea>
                    ...
                    <tr>  
                        <td colspan="4">
                          <button type="submit" name="albumdetailsenglish" class="btn btn-info btn-sm" >Submit</button> 
                        </td>
                    </tr>
