...
if(isset($_GET['form']))
{
    ...
    $sql="select title,e_title,e_description,day,month,year from ".$table_name." where id='".$formid."'";
    $q=mysql_query($sql);
...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="col-md-12">             
            <h4>Timeline Details in English<span style="float:right"><a href="timeline.php" class="btn btn-info btn-sm">Back</a></span></h4>
                ...
                <table class="table">
                  <tr class="info">
                    ...
                    <tr>
                      <td>Description</td>
                        <td colspan="3">
                        <textarea  name="edescription" class="form-control input-sm" required ><?=$edescription?></textarea>
                    ...
                    <tr>  
                        <td colspan="4">
                          <button type="submit" name="timelineenglish" class="btn btn-info btn-sm">Submit</button> 
                        </td>
                    </tr>
