      ...
      <ul class="navbar-nav ml-auto">
        <!--li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle mr-lg-2" id="messagesDropdown" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            <i class="fa fa-fw fa-envelope"></i>Profile
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu dropdown-menu-right" aria-labelledby="profileDropdown">
            ...
            <a class="dropdown-item" href="boardofdirectors.php">Board of Directors</a>
           
            <a class="dropdown-item" href="artistprofiles.php">Artist Profile</a>
          </div>
          
        </li>
        <li class="nav-item">
          <a class="nav-link" href="courses.php">
            <i class="fa fa-fw fa fa-book"></i>Courses</a>
        </li>
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" href="#" id="downloadDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            <i class="fa fa-fw fa fa-download"></i>Downloads
          </a>
          <div class="dropdown-menu dropdown-menu-right" aria-labelledby="downloadDropdown">
            <!--a class="dropdown-item" href="#">Settings</a-->
            <a class="dropdown-item" href="ebrochures.php">E-brochure</a>
           
            <a class="dropdown-item" href="applicationforms.php">Application Forms</a>
          </div>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="">
            <i class="fa fa-fw fa-sign-out"></i>Others</a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link" href="profile.php">
            <i class="fa fa-fw fa-wrench"></i>Settings</a>
        </li>
        <li class="nav-item">
