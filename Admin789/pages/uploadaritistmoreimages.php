...
if(isset($_GET['artist']))
{
    ...
    $table_name="artists";
    $sql="select name,qualification from ".$table_name." where id='".$artistid."'";
    $q=mysql_query($sql);
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <!-- content-->
        <div class="row">
          <div class="col-md-12">
            <h2>Upload Images for Artist<span style="float:right"><a href="artistprofiles.php" class="btn btn-info btn-sm">Back</a></span></h2>
             <hr>                                                                
            <div class="card-header">
                <i class="fa fa-table"></i> Upload Images for Artist name: <?=$name." ,Qualification : ".$qualification?></div>
              ...
              <form action="php/add.php" method="post" enctype="multipart/form-data">
                  <div class="form-row"> 
                    ...
                    <input type="file" class="form-control col-md-3" name="newupload[]" required  multiple=""/>&nbsp;
                     <button type="submit" name="uploadartistimages" class="btn btn-info">Upload Multiple Images</button>
                  </div>
          ...
          <div class="col-md-12 " id="details"> 
                ...
                <input type="hidden" name="enid" value="<?=$_GET['artist']?>"> 
                <div class="col-md-12">
                  ...
                  <input style="margin-top: 10px" type="submit" class="btn  btn-sm btn-danger" name="aritistimagedel"value="Delete photo" id="photobtn" disabled="disabled">
                  <br><br>
                </div>
                  <?php
                  ...
                  <?php 
                    ...
                    $table_nme = 'artistimages';      
                   
                    
                    $result="SELECT id,imagename FROM $table_nme WHERE artistid='$artistid'";
