...
if(isset($_GET['id']))
{
    ...
    $sql="select gallery.title,gallery.description,gallerysubcategory.name,gallerycategory.category,gallery.imagename,gallery.subcategoryid from ".$table_name1." inner join ".$table_name2." on gallerysubcategory.id=gallery.subcategoryid inner join ".$table_name3." on gallerycategory.id=gallerysubcategory.categoryid where gallery.id='".$id."'";
    $q=mysql_query($sql);
    if($row=mysql_fetch_array($q))
    {
     ...
     // $imagename=$row['imagename'];
      ...
      $enid=urlencode(base64_encode($subcategoryid));
...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="col-md-12">             
            <h4>Edit Details of Image :                  
                  <a href="<?= $dataorg?>" style="text-decoration: none;" data-title="<?=$imagename?>" class="text-center btn ntn-success btn-xs" data-lightbox="images"><?=$imagename?></a>
               
              <span style="float:right"><a href="uploadgallery.php?id=<?=$enid?>" class="btn btn-info btn-sm">Back</a></span></h4>
                  ...
                  <tr class="info">
                    ...
                    <tr>
                        ...
                        <td colspan="4">
                          ...
                          <input type="text" name="name" disabled class="form-control" value="<?=$name?>">
                        </td>
                    </tr>
                    <tr>
                        <td>Title</td>
                    ...
                    <tr>  
                        <td colspan="4">
                          <button type="submit" name="editgalleryinfo" class="btn btn-info btn-sm">Submit</button> 
                        </td>
                    </tr>
