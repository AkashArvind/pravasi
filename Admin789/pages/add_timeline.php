...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="col-md-12">             
            <h4>Add New Timeline<span style="float:right"><a href="timeline.php" class="btn btn-info btn-sm">Back</a></span></h4>
                ...
                <table class="table">
                  <tr class="info">
                    ...
                    <tr>
                      <td>വിവരണം</td>
                        <td colspan="3">
                        <textarea name="description" name="description" class="form-control input-sm" required></textarea>
                      ...
                      <td>തീയതി</td>
                       <td colspan="3">
                         <div class='input-group date' id='form_datetime'>
                                  ...
                                  <input type='text' class="form-control"  name="form_datetime" required /><br>
                    ...
                    <tr>  
                        <td colspan="4">
                          <button type="submit" name="addtimeline" class="btn btn-info btn-sm">Submit</button> 
                        </td>
                    </tr>
