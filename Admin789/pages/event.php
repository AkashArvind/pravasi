                      ...
                      while ($r = mysql_fetch_array($q1)) 
                      {
                       ...
                       <tr>
                                ...
                                <div class="modal-dialog modal-lg" role="document">
                                  <div class="modal-content">
                                    <div class="modal-header">
                                      <h4  class="modal-title" id="exampleModalLabel">ഇവന്റ് വിശദാംശങ്ങൾ</h4>
                                    ...
                                    <div class="modal-body">
                                      <div class="form-row">
                                         <label for="Name" class="col-sm-3">ശീർഷകം</label>
                                          <div class="col-sm-9">
                                      ...
                                      <div class="form-row">
                                         <label for="Name" class="col-sm-3">സ്ഥലം</label>
                                          <div class="col-sm-9">
                                     ...
                                     <div class="form-row">
                                         <label for="Name" class="col-sm-3">തീയതി</label>
                                          <div class="col-sm-9">
                                            <label for="studentname">
                                            <?=" : ".$ndate?></label> 
                          ...
                          <td class='text-center'>
                            <a href="eventenglish.php?event=<?=urlencode(base64_encode($r['event_id']))?>" style="text-decoration: none;">English</a>
                          </td>
                      </tr>
                      <?php
                      }
