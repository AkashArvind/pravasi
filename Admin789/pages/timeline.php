    ...
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="col-md-12">
            <h2>Timeline</h2>
            <hr>
            <a  style="float:right" href="add_timeline.php" class="btn btn-info btn-sm text-right">Add New</a> <br><br>
            <?php
            if(isset($_GET['msg'])){
              ?>
            ...
            <form action="php/delete.inc.php" method="get" name="checkboxFormPhotos" id="checkboxFormPhotos" onsubmit="return confirm('Delete selected news?');"> 
                <div class="col-md-12">
                  ...
                  <input style="margin-top: 10px" type="submit" class="btn  btn-sm btn-danger" name="timelinedel"value="Delete " id="photobtn" disabled="disabled">
                  <br><br>
                  <?php
                  ...
                  $result="SELECT id,description,title,day,month,year FROM $table_nme ORDER BY id DESC ";
                      ...
                      <table class="table table-striped"  id="example" cellspacing="0" width="100%">
                          <thead>
                              <tr class="info">
                                  ...
                                  <th class='text-center'>Timeline Details</th>
                              </tr>
                          </thead>
                          <tbody>
                    <?php
                      while ($r = mysql_fetch_array($q1)) 
                      {
                       ...
                       <tr>
                          ...
                          <td  class='text-right'>
                              <a href="edittimeline.php?form=<?=urlencode(base64_encode($r['id']))?>" ><span class="icon fa fa-edit fa-2x"></span></a>
                          </td>
                          <td class='text-center'>
                            <a href="timelineenglish.php?form=<?=urlencode(base64_encode($r['id']))?>" style="text-decoration: none;">English</a>
                          </td>
                      </tr>
                      <?php
                      }
