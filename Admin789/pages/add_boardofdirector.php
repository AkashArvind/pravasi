  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <div class="row">
        ...
        <div class="col-md-12">             
            <h4>Add New Board of Director<span style="float:right"><a href="boardofdirectors.php" class="btn btn-info btn-sm">Back</a></span></h4>
                  ...
                  <tr class="info">
                    ...
                    <tr>
                      <td>Work Experiences</td>
                        <td colspan="3">
                        <textarea name="workexperience" class="form-control input-sm" required></textarea>
                    ...
                    <tr>
                      <td>Awards</td>
                        <td colspan="3">
                        <input type="file" class="form-control input-sm" name="award[]" required="required" multiple="">
                    ...
                    <tr>  
                        <td colspan="4">
                          <button type="submit" name="addboardofdirector" class="btn btn-info btn-sm">Submit</button> 
                        </td>
                    </tr>
