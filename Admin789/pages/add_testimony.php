    ...
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="col-md-12">         
            <h2>Testimonials</h2>
            <hr>
            <h4>Add New Testimonials<span style="float:right"><a href="testimony.php" class="btn btn-info btn-sm">Back</a></span></h4>
                ...
                <table class="table">
                  <tr class="info">
                    ...
                    <tr>
                        <td>Content</td>
                        <td colspan="3">
                          <textarea class="form-control input-sm" name="content" required="required"></textarea>
                        </td>
                    </tr>
                    <tr>
                      <td>Name</td>
                    ...
                    <tr>
                        <td colspan="4">
                          <button type="submit" name="testimony" class="btn btn-info btn-sm">Submit</button>
