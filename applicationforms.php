			                  ...
			                  ?>
								...
								<div class="col-12">
									...
									<h4 class="dHead"><?= $title ?>
										...
										<span style="float: right"><form method="get" action="assets/images/applicationforms/<?= $filename ?>" target="_blank"><button type="submit" class="Iconbtn"><i class="fa fa-download"></i> DOWNLOAD</button></form></span>
