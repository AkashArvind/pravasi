...
if(isset($_GET['form']))
{
    $formid=base64_decode(urldecode($_GET['form']));
    $table_name="applicationforms";
    $sql="select title,filename from ".$table_name." where id='".$formid."'";
    $q=mysql_query($sql);
    if($row=mysql_fetch_array($q))
    {
      ...
      $photo=$row['filename'];
        $dataorg="../../assets/images/applicationforms/".$photo;
...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="col-md-12">             
            <h4>Edit Application Form :
                  <?php
                $info = pathinfo($photo);
                if ($info["extension"] == "pdf")
                {?>
                  <a href="../../assets/images/applicationforms/<?= $photo ?>" target="_blank" class="text-center btn ntn-success btn-xs"><?=$photo?></a>
                 <?php
                }
                else
                {?>
                ...
                ?>
              <span style="float:right"><a href="applicationforms.php" class="btn btn-info btn-sm">Back</a></span></h4>
            ...
            <div class="table-responsive">
                <table class="table">
                  <tr class="info">
                    ...
                    <tr>  
                        <td colspan="4">
                          <button type="submit" name="editapplicationform" class="btn btn-info btn-sm">Submit</button> 
                        </td>
                    </tr>
