...
if(isset($_GET['board']))
{
    ...
    $sql="select name,position from ".$table_name." where id='".$directorid."'";
    $q=mysql_query($sql);
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <!-- content-->
        <div class="row">
          <div class="col-md-12">
            <h2>Manage Awards of Board Director<span style="float:right"><a href="boardofdirectors.php" class="btn btn-info btn-sm">Back</a></span></h2>
             <hr>                                                                
            <div class="card-header">
                <i class="fa fa-table"></i> Manage Awards of Board of Director <?=$name." , ".$position?></div>
              ...
              <form action="php/add.php" method="post" enctype="multipart/form-data">
                  <div class="form-row"> 
                    ...
                    <input type="file" class="form-control col-md-3" name="newupload[]" required  multiple=""/>&nbsp;
                     <button type="submit" name="uploadawards" class="btn btn-info">Upload Multiple Awards</button>
                  </div>
          ...
          <div class="col-md-12 " id="details"> 
                ...
                <div class="col-md-12">
                  ...
                  <input style="margin-top: 10px" type="submit" class="btn  btn-sm btn-danger" name="awarddel"value="Delete photo" id="photobtn" disabled="disabled">
                  <br><br>
                </div>
                  <?php
                  ...
                  <?php 
                    ...
                    $table_nme = 'boarddirectorawards';      
                   
                    
                    $result="SELECT id,filename,description,title FROM $table_nme WHERE directorid='$directorid'";
                    ...
                    <div class="table-responsive ">
                      <table class="table table-striped" id="example" cellspacing="0" width="100%">
                          ...
                          while ($r = mysql_fetch_array($q1)) 
                          {
                            ...
                            $id=$r['id']; 
                            $dataorg="../../assets/images/boarddirectorawards/".$imagename;
                           ...
                           <tr>
                              ...
                              <td>
                                ...
                                {?>
                                  <a href="../../assets/images/boarddirectorawards/<?= $imagename ?>" target="_blank" class="text-center btn ntn-success btn-xs">View</a>
                                 <?php
                                }
                                else
                                {?>
                              ...
                              <td>
                                ...
                                {?>
                                  <a  class="btn ntn-success btn-xs" href="add_awardinfo.php?id=<?=urlencode(base64_encode($id))?>">Add</a>
                                ...
                                {?>
                                <a  class="btn ntn-success btn-xs" href="editawardinfo.php?id=<?=urlencode(base64_encode($id))?>">Edit/View</a>
                                 <?php
                                }
                                ?>
                              </td>
