...
if(isset($_GET['id']))
{
    $categoryid=base64_decode(urldecode($_GET['id']));
    $table_name="gallerycategory";
    $sql="select category from ".$table_name." where id='".$categoryid."'";
    $q=mysql_query($sql);
...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="col-md-12">             
            <h4>Edit Gallery Category : <?=$category?><span style="float:right"><a href="gallery.php" class="btn btn-info btn-sm">Back</a></span></h4>
                ...
                <table class="table">
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                          ...
                          <input type="text" class="form-control input-sm" name="category" required="required" value="<?=$category?>">
                        </td>
                    </tr>
                    ...
                    <tr>  
                        <td colspan="4">
                          <button type="submit" name="editgallerycategory" class="btn btn-info btn-sm">Submit</button> 
                        </td>
                    </tr>
