...
if(isset($_GET['id']))
{
    ...
    $table_name2="artists";
    $sql="select artists.name,artistcertificates.filename,artistcertificates.artistid,artistcertificates.title,artistcertificates.description from ".$table_name." inner join ".$table_name2." on artists.id=artistcertificates.artistid where artistcertificates.id='".$id."'";
    $q=mysql_query($sql);
...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="col-md-12">             
            <h4>Edit Details of Certificate :
               <?php
