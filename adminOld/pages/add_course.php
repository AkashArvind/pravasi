...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="col-md-12">             
            <h4>Add New Course<span style="float:right"><a href="courses.php" class="btn btn-info btn-sm">Back</a></span></h4>
                ...
                <table class="table">
                  <tr class="info">
                    ...
                    <tr>
                        <td>Sub Heading</td>
                        <td colspan="3">
                          <textarea name="subheading" rows="" cols="40" name="name" class="form-control input-sm"  required></textarea>
                    ...
                    <tr>
                      <td>Description</td>
                        <td colspan="3">
                        <textarea name="description" rows="5" cols="40" name="description" class="form-control input-sm" required></textarea>
                    ...
                    <tr>
                      <td>Image</td>
                       <td colspan="3">
                       <input type="file" class="form-control input-sm" id="photo" name="photo"  required accept="image/png,image/jpg,image/jpeg">
                    ...
                    <tr>  
                        <td colspan="4">
                          <button type="submit" name="addcourse" class="btn btn-info btn-sm">Submit</button> 
                        </td>
                    </tr>
