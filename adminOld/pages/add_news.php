...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="col-md-12">             
            <h4>Add New News<span style="float:right"><a href="news.php" class="btn btn-info btn-sm">Back</a></span></h4>
            ...
            <div class="table-responsive">
                <table class="table">
                  <tr class="info">
                    ...
                    <tr>  
                        <td colspan="4">
                          <button type="submit" name="newnews" class="btn btn-info btn-sm">Submit</button> 
                        </td>
                    </tr>
