                  ...
                  <tr class="info">
                    ...
                    <tr>
                     ...
                     <tr>
                      <td>Sub Heading</td>
                       <td colspan="3">
                          <textarea name="subheading" rows="" cols="40" name="name" class="form-control input-sm"  required><?=$subheading?></textarea>
                    ...
                    <tr>
                      <td>Description</td>
                        <td colspan="3">
                        <textarea name="description" rows="7" cols="40" name="description" class="form-control input-sm"  required><?=$description?></textarea>
