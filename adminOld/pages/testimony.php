    ...
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="col-md-12">
            <h2>Testimonials</h2>
            <hr>
            <a  style="float:right" href="add_testimony.php" class="btn btn-info btn-sm text-right">Add New</a> <br><br>
            <?php
            if(isset($_GET['msg'])){
              ?>
            ...
            <form action="php/delete.inc.php" method="post" name="checkboxFormPhotos" id="checkboxFormPhotos" onsubmit="return confirm('Delete selected Testimonials?');"> 
                <div class="col-md-12">
                  ...
                  <input style="margin-top: 10px" type="submit" class="btn  btn-sm btn-danger" name="testimony"value="Delete " id="photobtn" disabled="disabled">
                  <br><br>
                  <?php
                    ...
                    <?php
                      while ($r = mysql_fetch_array($q1)) 
                      {
                       ...
                       <tr>
                          ...
                          <td  class='text-right'>
                              <a href="edittestimony.php?testimony=<?=urlencode(base64_encode($r['id']))?>" ><span class="icon fa fa-edit fa-2x"></span></a>
                          </td>
