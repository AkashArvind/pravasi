...
class tblOp {
    ...
    function connect() {
        ...
        @mysql_select_db($this->db)or die("<span style='font-family:Arial, Helvetica, sans-serif; color:#FF0000; font-size:11px; font-weight:bold;'>An error occured :</span>" . mysqli_connect_errno());
...
//        echo $sql;
        ...
        if ($query) {
            ...
            $array = mysqli_fetch_array($query, MYSQL_ASSOC);
...
//        echo $sql;
    ...
    function joinQueryOne($sql) {
        ...
        if ($query) {
            ...
            //$array = mysqli_fetch_array($query, MYSQL_NUM);
            $array = mysqli_fetch_array($query);
            return $array[0];
