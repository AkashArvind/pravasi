<?php
	...
	if(empty($name)){
        ...
        $result = array( 'response' => 'error', 'empty'=>'phone', 'message'=>'<strong>Error!</strong>&nbsp; Phone number is empty.' );
        echo json_encode($result );
        die;
    }  
	...
	{	
		...
		$mail->Body =  "<h3>You have received a new message from kshethrakalaakademi.org</h3><br><b>Here are the details</b><br><br>Name:$name<br>Email: $email_address<br>Phone: $phone<br><h3></h3><i>'$message'</i>";
		$mail->AltBody = 'This is a plain-text message body';
		if($mail->send())
		{
			 $result = array( 'response' => 'success', 'message'=>'<strong>Thank You '.$name.'!</strong>&nbsp; Your email has been delivered.' );
		}
		else
		{
